			...
			<!--Making a contact-->
					...
					<div class="players">
							...
							<ul class="menu">
								...
								<li class="active"><a href="middle-blocker.php">Middle Blocker</a></li>
								<li><a href="libero.php">Libero</a></li>
						...
						<table>
							...
							include('config.php');
									...
									$s_query = mysql_query("SELECT * FROM players WHERE id_type = 0")
